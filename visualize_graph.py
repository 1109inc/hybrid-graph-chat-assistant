...
def build_pyvis(rows, output_html="neo4j_viz.html"):
    # Initializing Network without the networkx dependency (it's not used)
    # The 'directed=True' is good for relationship direction
    ...
    # FIX: Removed the notebook=False keyword argument
...
def main():
    ...
    # FIX: Explicitly close the driver to avoid the secondary warning
    driver.close()
